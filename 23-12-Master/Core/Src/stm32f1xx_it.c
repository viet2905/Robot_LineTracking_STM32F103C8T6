...
extern uint8_t txBuffer[4] ; //mang truyen du lieu
extern float wleft,wright; 
...
//			}
//			//mau = f[0] + f[1] + f[2];
//			if( f[1] - f[0] < 100 && f[1] > f[0])
//			{
//				Mau = 1; // blue
//			}
//			
//			else if(  f[1] - f[0] > 100 && f[1] > f[0]  )
//			{
//				Mau = 2; // green
//			}
//			else if ( f[0] - f[1] > 100 && f[0] > f[1]  )
//			{
//				Mau = 3; // red
//			}
//			else Mau = 0; 	Color = 1; 
